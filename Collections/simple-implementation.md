...
* [Coupon code validator](../Solutions/C/coupon-code-validator)
...
* [Smallest index with digit sum equal to index](../Solutions/S/smallest-index-with-digit-sum-equal-to-index)
